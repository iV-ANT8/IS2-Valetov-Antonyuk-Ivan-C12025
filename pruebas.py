...
try:
    ...
    prestamo1.fecha_devolucion = date.today() + timedelta(days=1)  # Simular devolución a tiempo
...
try:
    ...
    prestamo3.fecha_devolucion = date.today() - timedelta(days=5)  # Simular devolución tardía
